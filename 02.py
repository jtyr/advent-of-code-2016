...
def move(keypad, x, y, direction):
    if direction == 'U' and keypad[x-1][y] is not None:
        return x-1, y
    elif direction == 'D' and keypad[x+1][y] is not None:
        return x+1, y
    elif direction == 'R' and keypad[x][y+1] is not None:
        return x, y+1
    elif direction == 'L' and keypad[x][y-1] is not None:
        return x, y-1
    else:
        return x, y
